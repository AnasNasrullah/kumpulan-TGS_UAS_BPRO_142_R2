...
{"QOW12","Al-Qowam","Mukjizat Kesembuhan dalam Jintan Hitam, Madu, Bawang Putih dan B","14000"}
 ...
 public static String cariNim(String id){
  int idx=0;
 ...
 public static String cariNama(String produsen){
 	int counter1=0;
					for(int i=0;i<tblHerbal.length;i++)
					{
					if(tblHerbal[i][1].toLowerCase().contains(produsen.toLowerCase()))
						{
  ...
  public static String cariBarang(String barang){
 		
					int counter2=0;
					for(int k =0;k<tblHerbal.length;k++)
					{
						if(tblHerbal[k][2].toLowerCase().contains(barang.toLowerCase()))
						{
							System.out.println(tblHerbal[k][0]+" || "+tblHerbal[k][1]+" || "+tblHerbal[k][2]+" || "+tblHerbal[k][3]);
								counter2=1;
						}
  ...
  public static String cariHarga(String harga){
 	int counter = 0;
						for(int k =0;k<tblHerbal.length;k++)
						{
							if(tblHerbal[k][3].toLowerCase().contains(harga.toLowerCase()))
								{
									System.out.println(tblHerbal[k][0]+" || "+tblHerbal[k][1]+" || "+tblHerbal[k][2]+" || "+tblHerbal[k][3]);
									counter=1;
								}
...
BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
	...
	int pil = 0;
		...
		do 
		{
			...
			System.out.println("1. Cari data produk per ID");
			System.out.println("2. Penyaringan data product per produsen");
			System.out.println("3. Penyaringan data product per nama product");
			System.out.println("4. Penyaringan data product per harga");
			...
			System.out.println();
				...
				switch(pil)
				{
					...
					System.out.println();
					System.out.println("=======================");
					System.out.println("cari data produk per ID");
					System.out.println("=======================");
					System.out.print("Masukan ID :");
					String id = br.readLine();
					System.out.println("Hasil :");
					System.out.println(cariNim(id));
					System.out.println("");
					...
					System.out.println();
					System.out.println("=====================================");
					System.out.println("Penyaringan data product per produsen");
					System.out.println("=====================================");
					System.out.print("Masukan Nama produsen :");
					String produsen=br.readLine();
					System.out.println("Hasil :");
					System.out.println(cariNama(produsen));
					System.out.println(" ");
					...
					System.out.println();
					System.out.println("=========================================");
					System.out.println("Penyaringan data product per nama product");
					System.out.println("=========================================");
					System.out.print("masukan nama barang: ");
					String barang=br.readLine();
					System.out.println("Hasil :");
					System.out.println(cariBarang(barang));
					System.out.println(" ");
					...
					System.out.println();
					System.out.println("==================================");
					System.out.println("Penyaringan data product per harga");
					System.out.println("==================================");
					System.out.print("masukan harga: ");
					String harga=br.readLine();
					System.out.println("Hasil :");
					System.out.println(cariHarga(harga));
					System.out.println("");
